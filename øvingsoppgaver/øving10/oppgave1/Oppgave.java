...
public class Oppgave {
    public static void main(String[] args) {
        ...
        arrangementRegister.registrer(5, "Movie night", "Lerkendal", "Kiwi", "Barneteater", 200309301800L);
        ...
        while (true){
            ...
            switch (valg) {
                case 1:
                    ...
                    arrangementRegister.registrer(arrangementRegister.getArrang().size(), name, place, organizer, type, date);
